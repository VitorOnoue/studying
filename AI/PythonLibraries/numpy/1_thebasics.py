...
# getting size of the data type
print(array.itemsize)
print(array_2d.itemsize)

# so, its possible to get the size of the array with itemsize * length, or simply with nbytes
print(array.itemsize * 3)
print(array_2d.nbytes)  # 8 bytes times 6